"use strict";
cc._RF.push(module, '01ee7Z2d2VKpqPaeHILPVsl', 'roadManager');
...
cc.Class({
    ...
    deadLineWarn: function deadLineWarn() {
    ...
    onClickWater: function onClickWater(event) {
    ...
    spawnStoneNotify: function spawnStoneNotify(data) {
    ...
    spawnStone: function spawnStone() {
        this.roadId++;
        if (GLB.isRoomOwner) {
            var data = {
                ID: this.roadId,
    ...
    recycleStone: function recycleStone(obj) {
    ...
    deadSlowdown: function deadSlowdown() {
